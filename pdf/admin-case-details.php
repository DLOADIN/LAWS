...
$sql=mysqli_query($con,"SELECT `user`.u_name,`cases`.u_firstname,`cases`.u_lastname,`cases`.u_email,`cases`.u_phonenumber,`cases`.u_nid,`cases`.u_residence,`cases`.u_nationality,`cases`.u_casedetails,`cases`.u_date FROM `cases` INNER JOIN `user`");
